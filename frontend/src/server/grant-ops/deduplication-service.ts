 ...
 */
async function addDuplicateCandidates(matches: DuplicateMatch[]): Promise<DuplicateCandidate[]> {
 ...
 */
async function _checkForDuplicatesAfterCrawl(newGrant: Grant): Promise<DuplicateMatch[]> {
  const deps = getDependencies();
