...
> = {
  'not-installed': {
    ...
    action: 'Install opencode from https://opencode.ai and ensure it is on PATH.',
  },
  'not-reachable': {
    ...
    action: 'Verify that opencode is properly installed and executable (chmod +x on macOS/Linux).',
  },
  incompatible: {
