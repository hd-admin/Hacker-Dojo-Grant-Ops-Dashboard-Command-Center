...
export interface SubmissionReadinessProps {
  ...
  onSubmitComplete: (data: { confirmationNumber: string; submittedAt: string }) => void;
}
    ...
    <div className="submission-readiness" role="region" aria-label="Submission readiness">
      ...
      {!submitted && (
        <div className="drawer-section">
          ...
          <div className="drawer-note">
            After completing submission on the funder portal, record the confirmation details here.
          </div>
          <input
            type="text"
      ...
      {submitted && (
        <div className="drawer-section">
          ...
          <div className="drawer-note">✓ Submission recorded at {new Date().toLocaleString()}</div>
          {confirmationNumber && (
            <div className="drawer-note">Confirmation: {confirmationNumber}</div>
          )}
        </div>
      )}
    </div>
