declare module 'better-sqlite3' {
  ...
  export default class Database {
    ...
    function(name: string, options: { deterministic?: boolean; varargs?: boolean; directOnly?: boolean }, fn: (...args: unknown[]) => unknown): void;
    aggregate(name: string, options: { start: () => unknown; step: (total: unknown, next: unknown) => unknown; result?: (total: unknown) => unknown; deterministic?: boolean; varargs?: boolean; directOnly?: boolean }): void;
